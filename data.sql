...
--
-- Table structure for table `clasz`
--

DROP TABLE IF EXISTS `clasz`;
...
--
-- Dumping data for table `clasz`
--

LOCK TABLES `clasz` WRITE;
/*!40000 ALTER TABLE `clasz` DISABLE KEYS */;
INSERT INTO `clasz` VALUES ('f453d','https://i.imgur.com/SHrpSc1.jpeg',NULL,'c#');
...
CREATE TABLE `history` (
  ...
  KEY `FKc5qpyp1n9rwwcvei0k7j6mtxt` (`questionsid`),
  CONSTRAINT `FKc5qpyp1n9rwwcvei0k7j6mtxt` FOREIGN KEY (`questionsid`) REFERENCES `question` (`questionsid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `invalidete_token`
--

DROP TABLE IF EXISTS `invalidete_token`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `invalidete_token` (
...
--
-- Dumping data for table `invalidete_token`
--

LOCK TABLES `invalidete_token` WRITE;
/*!40000 ALTER TABLE `invalidete_token` DISABLE KEYS */;
INSERT INTO `invalidete_token` VALUES ('6d228b0c-9a70-4a3e-8fb6-42936051c743','2024-12-20 13:27:58.000000'),('e7318850-a96e-4cac-8782-6dad4ea37cfa','2024-12-20 10:37:49.000000');
/*!40000 ALTER TABLE `invalidete_token` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `question` (
  ...
  CONSTRAINT `FKisqd64a7oqr5gd57690rk2cgx` FOREIGN KEY (`testid`) REFERENCES `test` (`testid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `test` (
  ...
  PRIMARY KEY (`testid`),
  KEY `FK6reujcx5s28l7e08rlx1w5m8g` (`classid`),
  KEY `FKqys63qo2geuh95arowdbr29f1` (`userid`),
  CONSTRAINT `FK6reujcx5s28l7e08rlx1w5m8g` FOREIGN KEY (`classid`) REFERENCES `clasz` (`classid`),
  CONSTRAINT `FKqys63qo2geuh95arowdbr29f1` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_class_role` (
  ...
  `userid` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK1x3clj0gpm63p0wbjx10r64ie` (`classid`),
  KEY `FKc29rfd4h4gipu1g3pi5lv0m53` (`userid`),
  CONSTRAINT `FK1x3clj0gpm63p0wbjx10r64ie` FOREIGN KEY (`classid`) REFERENCES `clasz` (`classid`),
  CONSTRAINT `FKc29rfd4h4gipu1g3pi5lv0m53` FOREIGN KEY (`userid`) REFERENCES `user` (`userid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
